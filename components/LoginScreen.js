...
import {
    ...
    AlertTriangle, ArrowLeft, CheckCircle2, Sun, Moon, Phone
} from 'lucide-react';
...
export default function LoginScreen() {
    ...
    return (
        <div className={rootClass} style={{ fontFamily: 'Inter, ui-sans-serif, system-ui' }}>
                    ...
                    {view === 'login' && (
                        <>
                            <CardHeader className="text-center pb-2 flex flex-col items-center">
                                {/* NEW: Phone Number Top Link */}
                                <a
                                    href={whatsappLink}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className={`inline-flex items-center gap-2 text-sm font-medium mb-4 transition-colors ${theme === 'light' ? 'text-green-700 bg-green-50 hover:bg-green-100 px-3 py-1.5 rounded-full' : 'text-green-400 bg-green-900/20 hover:bg-green-900/30 px-3 py-1.5 rounded-full'}`}
                                >
            ...
            {/* --- NEW: Floating WhatsApp Button (Bottom Right) --- */}
            <a
                href={whatsappLink}
                target="_blank"
                rel="noopener noreferrer"
