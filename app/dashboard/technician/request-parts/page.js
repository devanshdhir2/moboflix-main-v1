    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
                <h2 className="text-3xl font-bold text-gray-800">Request Parts</h2>
                <p className="text-gray-500 mb-8">Submit a request for parts needed for your repairs.</p>
                
                <form onSubmit={handleSubmitRequest} className="space-y-6">
                    <div>
                        <label htmlFor="partName" className="text-lg font-semibold text-gray-700">Part Name</label>
                        <input
                            id="partName"
                            type="text"
                            value={partName}
                    ...
                    <div>
                        <label htmlFor="notes" className="text-lg font-semibold text-gray-700">Notes (Optional)</label>
                        <textarea
                            id="notes"
                            value={notes}
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-blue-600 text-white font-bold py-4 px-6 rounded-lg shadow-lg hover:bg-blue-700 transition-all disabled:bg-gray-400"
                    >
