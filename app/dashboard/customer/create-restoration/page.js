...
export default function CreateRestorationPage() {
        ...
        try {
            if (user) {
                await addDoc(collection(db, "tickets"), {
                    ...
                    issueDescription,
                    address,
                    appointmentDate: new Date(), // Set appointment for right now
                    status: 'Pending',
                    type: 'Restoration', // Set ticket type
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <h2 className="text-3xl font-bold text-gray-800">Book Phone Restoration</h2>
            <p className="text-gray-500 mb-8">Confirm details to book an immediate restoration service.</p>
            
            <form onSubmit={handleCreateTicket} className="space-y-8">
                <div>
                    <label className="text-lg font-semibold text-gray-700">1. What device needs restoration?</label>
                    <input type="text" value={deviceInfo} onChange={(e) => setDeviceInfo(e.target.value)} placeholder="e.g., iPhone X" className="w-full mt-2 p-4 border border-gray-300 rounded-lg" required />
                </div>
                <div>
                ...
                <div>
                    <label className="text-lg font-semibold text-gray-700">3. Service Address</label>
                ...
                <div>
                    <label className="text-lg font-semibold text-gray-700">5. Choose a Technician</label>
                    <div className="mt-2">
